"""Auto-generated by catfish_freeze_skill (2026-05-12 16:11:17).

skill:        department/eis-checkin
description:  登录 EIS 后点上班打卡按钮, 返回打卡时间
source trace: /Users/chenhongbo/.catfish/traces/session_eis-checkin_20260512_161115_f9138b.jsonl (8 steps)
...
logger = logging.getLogger("catfish.skill.eis_checkin")
...
def render_eis_checkin(
    ...
    **_kwargs: Any,
    ...
    try:
        ...
        last_step = "click:div.title"
        _r = _call("catfish_browser_click", {"selector": 'div.title'})
        if not _r.get("ok"): raise _SkillStepFailure("click", _r.get("error", "click 失败"))
        return {
            "ok": True,
