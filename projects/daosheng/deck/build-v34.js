// 稻生万物智能制造建设方案 · v34 · 24 页
//
// ═══ v34 vs v33 (7/28 鸿波第二十一轮) ═══
//
// 鸿波: "研产销一体化产业园变成谷千禾研产销一体化产业园"
//
// 园区冠上公司名。至此两个名字的分工确定:
//   **谷千禾** —— 公司/园区主体名, 用于园区全称
//   **稻生万物** —— 品牌名, 用于方案标题与正文
//
// 这条推翻了 v15 时的处置: 当时"谷千禾 / 谷千合"两种写法未确认,
// 鸿波定"统一用稻生万物品牌, 不写注册名"。现在鸿波明确写了「谷千禾」,
// 视为公司名已确认, README 相应更新。
//
// 改动: 封面副标 + 页脚, 共两处。
//   封面   研产销一体化产业园 · 上海临港新片区
//        → 谷千禾研产销一体化产业园 · 上海临港新片区
//   页脚   稻生万物智能制造建设方案 · 研产销一体化产业园 · 上海临港新片区
//        → 稻生万物智能制造建设方案 · 谷千禾研产销一体化产业园 · 上海临港新片区
//
// 页脚加长 3 字, 原 w:11 够用（build 后已过几何检查确认不越界）。
//
// ═══ 延续的结构性决定 ═══
...
//   ⑩ 验收指标只列本方能负责的 —— 产线效益指标由设备与工艺决定, 不承诺
//
// ═══ 军规 ═══
//   - 不点"鲶鱼"品牌名 · 不出现"自主研发/自研"
//   - 标签自带意思 · 布局宽度倒算不写死常数
//   - **build 后必跑 check-geometry.py（越界 / 遮挡 / 压页脚 三项）**
//   - 改行高必须同步改色条 —— 今天犯了三次（p7-9 任务卡 / p14 分层 / p16 左列）
//   - 不出现申报 / 政策 / 补贴 / 固投 / 管委会
//   - 不点具体开源模型名 · 配置 [待核定] · 指标目标 [待定]
//
// 数据来源:
...
p.title = "稻生万物智能制造建设方案 · 谷千禾研产销一体化产业园";
p.author = "稻生万物";
...
function footer(s) {
  s.addText("稻生万物智能制造建设方案  ·  谷千禾研产销一体化产业园  ·  上海临港新片区", {
...
// ═══════════════════════════════ P1 · 封面
{
  ...
  s.addText("谷千禾研产销一体化产业园  ·  上海临港新片区", {
...
p.writeFile({ fileName: "daosheng-v34-smart-mfg.pptx" })
  .then(() => console.log("✓ daosheng-v34-smart-mfg.pptx  ·  24 页"));
