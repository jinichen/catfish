// 稻生万物研产销一体化产业园 · AI Native 数字化方案 · v27 · 24 页
//
// ═══ v27 vs v26 (7/28 鸿波第十五轮) ═══
//
// 鸿波: "下一步去掉，风险和应对那也去掉"
//
// 删两页: 关键风险与应对 · 下一步
//
// 合理性: 本方案要并入稻生万物自己的材料 ——
//   · 「风险与应对」他们会有自己的口径, 我方另出一份容易打架
//   · 「下一步」隐含的是我方的推进节奏, 属商务范畴, 不该混在技术方案里
// 删掉后本方案更纯粹: 只回答"这套系统是什么、怎么建、谁做什么"。
//
// 收尾改为止于 P24 实施路径 —— 技术方案以路线图收尾是完整的,
// 不再另设结束页（另设就等于把"下一步"改个名字放回来）。
//
// ═══ 连带调整 ═══
//   目录  PART 6 取消, 实施路径并入 PART 5「建设内容 · 指标 · 实施」
//   风险页里那条"开源模型能力不及预期"(v26 新补) 随页删除 ——
//   但其内容在 P14 模型策略的「能力边界」框中已有, 不算丢失
//
// ═══ 延续的结构性决定 ═══
...
p.writeFile({ fileName: "daosheng-v27-tech.pptx" })
  .then(() => console.log("✓ daosheng-v27-tech.pptx  ·  24 页"));
