// 稻生万物智能制造建设方案 · v28 · 24 页
//
// ═══ v28 vs v27 (7/28 鸿波第十六轮) ═══
//
// 鸿波: "数字化方案改成稻生万物智能制造建设方案"
//
// 改名回到 7/28 最初定的题目。封面主标题、页脚、文档属性一并改。
// "AI Native" 保留为副标（kicker）—— 它是方法论定位, P2 整页在论证
// 为什么该走这条路线, 抽掉标题会让那页失去落点。
//
// ═══ 一个必须留在封面上的边界声明 ═══
//
// 题目叫「智能制造建设方案」, 读者会预期看到产线与装备内容;
// 但本方案已明确把产线设备选型、工艺路线、现场施工划出范围（P19 交付边界）。
// 若不在封面讲清, 会被误读为"漏写了产线部分"。
//
// 故封面保留并前移边界声明:
//   "本方案覆盖智能制造的数字化与 AI 部分  ·  产线设备选型与工艺路线由
//    建设方与设备供应商确定  ·  本方案提供接入规范与验收要求（见 P19）"
//
// 顺带修一处失效引用: v24 封面写"见 P4"指向交付边界, 但历经多轮插页后
// 交付边界已移到 P19, 该引用一直是错的。
//
// ═══ 延续的结构性决定 ═══
...
//   ⑥ 不提申报 / 政策 / 补贴 —— 由稻生万物自行考虑
//   ⑦ 不设「风险与应对」「下一步」—— 前者客户有自己口径, 后者属商务范畴
//
// ═══ 军规 ═══
//   - 不点"鲶鱼"品牌名 · 不出现"自主研发/自研"
//   - 不出现申报 / 政策 / 补贴 / 固投 / 管委会（禁塑政策等产业背景除外）
...
p.writeFile({ fileName: "daosheng-v28-smart-mfg.pptx" })
  .then(() => console.log("✓ daosheng-v28-smart-mfg.pptx  ·  24 页"));
