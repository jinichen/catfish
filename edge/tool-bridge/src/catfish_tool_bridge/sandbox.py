...
from .sandbox_limits import (  # noqa: F401 — preserve existing callers/tests
    _MACOS_SANDBOX_RLIMITS, _apply_macos_rlimits,
)
    ...
    *,
    ...
    if sandbox_kind is None:
        return {
            ...
            "stderr": (
                ...
                "Windows 需要可用的 Docker。已拒绝执行，不会绕过隔离。"
            ),
            "rc": -1,
            "elapsed_ms": 0.0,
            "timed_out": False,
    ...
    try:
        ...
        try:
            ...
            timed_out = True
            rc = -9  # Portable timeout status; Windows has no signal.SIGKILL.
