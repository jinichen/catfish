...
# (BL-TOOL-SPLIT 8/15: 90 行抽到 catfish_tools_backup.py)
# ============================================================

from .catfish_tools_backup import skill_backup  # noqa: E402

# ============================================================
# P3.5.177 catfish_wiki_ingest —— 员工显式入库 wiki
# (BL-TOOL-SPLIT 8/15: 135 行抽到 catfish_tools_wiki.py)
# ============================================================

from .catfish_tools_wiki import wiki_ingest  # noqa: E402
...
def _dispatch_native_inner(name: str, args: Dict[str, Any]) -> Any:
    ...
    # P3.5.177 (7/6 鸿波): 员工显式入库 wiki (kill P16 auto-ingest)
    if name == "catfish_wiki_ingest":
        return wiki_ingest(args)
