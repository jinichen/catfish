...
- git history: 真要恢复 git log --diff-filter=A --follow central/llm-gateway/src/catfish_gateway/a2a_audit.py
"""
from __future__ import annotations

_DEPRECATED_NOTICE = (
    "a2a_audit 5/26 砍 — A2A federation 整套停 (0 真客户 + 1695 LOC + 私钥违规). "
    "真要恢复从 git history 拉."
)
