...
from typing import Any  # noqa: F401 — 留给将来 read_journal / append_to_journal 扩展
...
# 5/23 BL-GATEWAY-DROP-LEGACY-SUMMARIZE (鸿波 task #5 Stage 1):
# inject_employee_journal 已删. 5/20 BL-GATEWAY-MEMORY-REGISTRY-DELETE 时
# 已 disable (registry.providers 永远空), 5/23 真删函数体. catfish-memory plugin
# (hermes 侧 prefetch) 接管 employee_journal + distilled_facts 注入路径.
# memory_distill 模块也已 rm, distilled_facts 由 plugin 自己读 (跟 catfish-memory
# _render_employee_journal 路径一致).
